  ...
  try {
    ...
    const brandsConfig = [
      ...
      },
      {
        name: 'Corsair',
        slug: 'corsair',
        email: 'corsair@kaia.tech',
        logo: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=300&auto=format&fit=crop&q=80',
        banner: 'https://images.unsplash.com/photo-1587202372634-32705e3bf49c?w=1600&auto=format&fit=crop&q=80',
        description: 'Winning is our legacy. Dominator DDR5 memory, MP600 Gen4 SSDs, and hydro-X liquid cooling.',
      ...
      },
      {
        ...
        slug: 'msi',
        email: 'msi@kaia.tech',
        logo: 'https://images.unsplash.com/photo-1591488320449-011701bb6704?w=300&auto=format&fit=crop&q=80',
        banner: 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=1600&auto=format&fit=crop&q=80',
        description: 'True Gaming. Enthusiast motherboards, GeForce RTX graphics cards, and high-FPS gaming displays.',
        website: 'https://in.msi.com',
    ...
    const productsSeedData = [
      ...
      // 11. Corsair Products
      {
        ...
        slug: 'corsair-dominator-titanium-rgb-64gb-ddr5',
        modelNumber: 'CMP64GX5M2B6000C30',
        sku: 'COR-DOMTIT-64GB-038',
        mrp: 29999,
        price: 24999,
        images: ['https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800'],
        desc: 'Forged aluminum construction with patented DHX cooling technology, swappable top bars, and 11 vibrant addressable CAPELLIX RGB LEDs.',
        specs: { MemoryType: 'DDR5', Capacity: '64GB (2 x 32GB)', TestedSpeed: '6000 MT/s', TestedLatency: '30-36-36-76', Profile: 'Intel XMP 3.0 & AMD EXPO' },
        stock: 35,
        isBestSeller: true,
      },
      {
        brand: 'corsair',
        category: 'storage',
        name: 'Corsair MP700 PRO 2TB PCIe 5.0 x4 NVMe M.2 SSD with Air Cooler',
        slug: 'corsair-mp700-pro-2tb-pcie5-ssd',
        modelNumber: 'CSSD-F2000GBMP700PRO',
        sku: 'COR-MP700PRO-2TB-039',
        mrp: 35999,
        price: 29999,
        images: ['https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=800'],
        desc: 'Next-gen Gen5 bandwidth delivering extreme sequential read speeds up to 12,400 MB/s and write speeds up to 11,800 MB/s.',
        specs: { Interface: 'PCIe Gen 5.0 x4', SequentialRead: 'Up to 12,400 MB/s', SequentialWrite: 'Up to 11,800 MB/s', FormFactor: 'M.2 2280 with Active Fan Heatsink' },
        stock: 20,
      },
      ...
      // 12. MSI Products
      {
        ...
        name: 'MSI GeForce RTX 4090 SUPRIM X 24G Graphics Card',
        slug: 'msi-geforce-rtx-4090-suprim-x-24g',
        modelNumber: 'RTX4090-SUPRIM-X',
        sku: 'MSI-RTX4090-SUPX-040',
        mrp: 249900,
        price: 224900,
        images: ['https://images.unsplash.com/photo-1591488320449-011701bb6704?w=800'],
        desc: 'TRI FROZR 3S thermal design with TORX Fan 5.0, vapor chamber, brushed aluminum shroud, and dual BIOS overclocking.',
        specs: { GPU: 'NVIDIA GeForce RTX 4090', VRAM: '24GB GDDR6X 384-bit', BoostClock: '2640 MHz (Extreme Performance)', PowerConnectors: '16-pin 12VHPWR' },
        stock: 8,
        isFeatured: true,
      },
      {
        brand: 'msi',
        category: 'motherboards',
        name: 'MSI MEG Z790 GODLIKE MAX E-ATX Motherboard',
        slug: 'msi-meg-z790-godlike-max',
        modelNumber: 'MEG-Z790-GODMAX',
        sku: 'MSI-Z790-GODMAX-041',
        mrp: 149900,
        price: 134900,
        images: ['https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800'],
        desc: 'Ultra-enthusiast motherboard with 4-inch full-color M-Vision touch dashboard display, 26+2 direct power phases, and 7x M.2 slots.',
        specs: { FormFactor: 'E-ATX', PowerPhases: '26+2 Duet Rail Power System (105A)', OnboardScreen: '4.0" IPS Touch M-Vision Dashboard', Networking: '10GbE + 2.5GbE + Wi-Fi 7' },
        stock: 5,
      },
