...
const Notifications = () => {
  ...
  return (
    <div className="space-y-8 text-left max-w-5xl mx-auto font-sans select-none">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-brand-gray-200 pb-5">
        <div>
          ...
          <p className="text-xs text-brand-gray-500 mt-1">
            System notifications for incoming orders, packing dispatch alerts, reverse return requests, and settlement updates.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-brand-gray-200 p-12 text-center rounded-sm shadow-premium space-y-3">
          ...
          <h3 className="text-sm font-bold text-brand-gray-700 uppercase">No notifications</h3>
